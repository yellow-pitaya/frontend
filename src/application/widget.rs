...
impl relm::Widget for Widget {
    ...
    fn view(relm: &relm::Relm<Self>, model: Self::Model) -> Self {
        ...
        relm::connect!(graph@graph::Signal::Draw, relm, super::Signal::GraphDraw);
        relm::connect!(graph@graph::Signal::Level(ref channel, offset), relm, super::Signal::Level(channel.clone(), offset));
        relm::connect!(graph@graph::Signal::Resize(w, h), relm, super::Signal::Resize(w, h));
        ...
        relm::connect!(acquire@acquire::Signal::Rate(rate), relm, super::Signal::AcquireRate(rate));
        relm::connect!(acquire@acquire::Signal::Start(source), graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Left, format!("{}", source)));
        relm::connect!(acquire@acquire::Signal::Stop(source), graph, graph::Signal::SourceStop(super::graph::level::widget::Orientation::Left, format!("{}", source)));
        ...
        relm::connect!(generator@generator::Signal::Amplitude(_, _), relm, super::Signal::NeedDraw);
        relm::connect!(generator@generator::Signal::DutyCycle(_, _), relm, super::Signal::NeedDraw);
        relm::connect!(generator@generator::Signal::Frequency(_, _), relm, super::Signal::NeedDraw);
        relm::connect!(generator@generator::Signal::Offset(_, _), relm, super::Signal::NeedDraw);
        relm::connect!(generator@generator::Signal::Form(_, _), relm, super::Signal::NeedDraw);
        relm::connect!(generator@generator::Signal::Start(source), graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Left, format!("{}", source)));
        relm::connect!(generator@generator::Signal::Stop(source), graph, graph::Signal::SourceStop(super::graph::level::widget::Orientation::Left, format!("{}", source)));
        ...
        window.add(&main_box);
        relm::connect!(relm, window, connect_destroy(_), super::Signal::Quit);
        ...
        relm::connect!(trigger@trigger::Signal::Auto, relm, super::Signal::TriggerAuto);
        relm::connect!(trigger@trigger::Signal::Normal, relm, super::Signal::TriggerNormal);
        relm::connect!(trigger@trigger::Signal::Single, relm, super::Signal::TriggerSingle);

        relm::connect!(trigger@trigger::Signal::Auto, graph, graph::Signal::SourceStop(super::graph::level::widget::Orientation::Right, "TRIG".to_owned()));
        relm::connect!(trigger@trigger::Signal::Normal, graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Right, "TRIG".to_owned()));
        relm::connect!(trigger@trigger::Signal::Single, graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Right, "TRIG".to_owned()));

        relm::connect!(trigger@trigger::Signal::Auto, graph, graph::Signal::SourceStop(super::graph::level::widget::Orientation::Top, "DELAY".to_owned()));
        relm::connect!(trigger@trigger::Signal::Normal, graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Top, "DELAY".to_owned()));
        relm::connect!(trigger@trigger::Signal::Single, graph, graph::Signal::SourceStart(super::graph::level::widget::Orientation::Top, "DELAY".to_owned()));
